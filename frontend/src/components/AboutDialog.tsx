                    ...
                    <div className="about-app-section">
                        ...
                        <div className="about-translations">
                            ...
                            <p className="about-contributors">
                                egesucu, ultrazg, viniciusmi00, appleboy, moseoh, EliShteinman, jferdi24
                            </p>
                            <p style={{ marginTop: "12px" }}>
                                <span
                                    className="clickable-link"
                                    onClick={() =>
                                        handleLinkClick("https://github.com/wickenico/WailBrew/discussions/129")
                                    }
                                    onKeyDown={(e) =>
                                        handleKeyDown(e, "https://github.com/wickenico/WailBrew/discussions/129")
                                    }
                                    role="button"
                                    tabIndex={0}
                                >
