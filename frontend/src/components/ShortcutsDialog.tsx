    ...
    const sections: ShortcutSection[] = [
        ...
        },
        {
            ...
            shortcuts: [
                ...
                { action: t('shortcuts.navigation.all'), keys: `${cmdKey}4` },
                { action: t('shortcuts.navigation.leaves'), keys: `${cmdKey}5` },
                { action: t('shortcuts.navigation.repositories'), keys: `${cmdKey}6` },
                { action: t('shortcuts.navigation.homebrew'), keys: `${cmdKey}7` },
                { action: t('shortcuts.navigation.doctor'), keys: `${cmdKey}8` },
                { action: t('shortcuts.navigation.cleanup'), keys: `${cmdKey}9` },
            ],
        },
        {
