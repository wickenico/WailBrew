import { ArrowDown, ArrowUp, CircleCheckBig, CircleX, Info, ShieldAlert, ShieldCheck } from "lucide-react";
        ...
        if (col.key === "status") {
            return (
                <span style={{ display: "inline-flex", alignItems: "center", gap: "10px" }}>
                    ...
                    {repo.trusted === true && (
                        <span
                            style={{ color: "#3ba55d", display: "inline-flex", alignItems: "center", gap: "4px" }}
                            title={t("repository.trusted")}
                        >
                            <ShieldCheck size={16} />
                        </span>
                    )}
                ...
                <div className="table-split-wrapper">
                    ...
                    <div className="table-footer">
                        <div className="table-footer-content">
                            {repositories.length}{" "}
                            {repositories.length === 1 ? t("table.repository") : t("table.repositories")}
                        </div>
                    </div>
                </div>
            )}
            {!loading && repositories.length === 0 && <div className="result">{t("table.noResults")}</div>}
        </div>
    );
};
