...
func (m *Manager) GetBackendMessage(key string, params map[string]string) string {
	...
	keyMap := map[string]string{
		...
		"trustStart":                  "backend.trust.start",
		"trustSuccess":                "backend.trust.success",
		"trustFailed":                 "backend.trust.failed",
		"errorStartingTrust":          "backend.errors.startingTrust",
		"serviceStart":                "backend.service.start",
		"serviceSuccess":              "backend.service.success",
		"serviceFailed":               "backend.service.failed",
		"errorStartingService":        "backend.errors.startingService",
